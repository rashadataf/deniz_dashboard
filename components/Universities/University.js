...
class NewUniversity extends React.Component {
  state = {
    ...
    titleError: "",
    arTitleError: "",
    establishmentYear: this.props.establishmentYear || "",
    ...
    localRate: this.props.localRate || "",
    localRateError: "",
    internationalRate: this.props.internationalRate || "",
    internationalRateError: "",
    studentsCount: this.props.studentsCount || "",
    studentsCountError: "",
    specializationsCount: this.props.specializationsCount || "",
    website: this.props.website || "",
    description: this.props.description || "",
    arDescription: this.props.arDescription || "",
    colleges: [],
    selectedColleges: this.props.selectedColleges || [],
    specializations: [],
    selectedSpecializations: this.props.selectedSpecializations || [],
    scientificDegrees: [],
    selectedScientificDegrees: this.props.selectedScientificDegrees || [],
    programs: [],
  ...
  handleUpdate = async () => {
    if (this.validateInput()) {
      ...
      const result = await AdminServices.universitiesServices.updateUniversity(
        this.state._id,
        formData
      );
      if (result) {
